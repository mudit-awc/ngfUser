 ...
 * @author Admin
 */
public class MultipleGRNInvoicing implements FormListener {
            ...
            case "MOUSE_CLICKED":
                switch (pEvent.getSource().getName()) {
                    ...
                    case "Btn_delete_multiplegrn":
                        System.out.println("Inside btn delete multiple grn");
...
//                            formObject.setVisible("Btn_Modify_Maintaincharges", false);
                    ...
                    case "grnenddate":
                        ...
                        Query = "select grnnumber from ext_supplypoinvoices where purchaseorderno = '" + formObject.getNGValue("purchaseorderno") + "' "
                                + "and format(grnsyncdate,'dd/MM/yyyy') between '" + formObject.getNGValue("grnstartdate") + "' and '" + formObject.getNGValue("grnenddate") + "'";
                        System.out.println("Query: " + Query);
                        ...
                        switch (formObject.getSelectedSheet("Tab1")) {
                            case 3: { //OtherCharges
                                ...
                                if (null != freightRate
                                    ...
                                    String calculatedamount = objCalculations.calculatePercentAmount(result1.get(0).get(0), freightRate);
                            ...
                            case 8: {
                                String AccessToken = new CallAccessTokenService().getAccessToken();
                                new CallPrePaymentService().GetSetPrePaymentLines(AccessToken, formObject.getNGValue("ponumber"), "Supply",processInstanceId);
                            }
                            break;
                        }
                        break;
